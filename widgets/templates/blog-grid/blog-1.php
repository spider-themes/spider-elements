...
<div class="spel-blog-grid-1">
                ...
                <div class="ezd-lg-col-<?php echo esc_attr($column_grid); ?> ezd-sm-col-6 blog-grid">
                    <div class="blog-meta-two">
                        <figure class="post-img">
                            ...
                            <?php echo wp_kses_post( '<a href="' . esc_url(spel_get_first_taxonomy_link()) . '" class="tags">' . spel_get_first_taxonomy() . '</a>' ); ?>
                        </figure>
                        <div class="post-data">
                            <div class="date">
                                <?php
    ...
    <?php
    if ('yes' === $settings['pagination_switcher']) {
        spel_pagination($post_query, 'spel-pagination spel-pl-0 spel-mt-48 ');
    }
    ?>
