...
<div class="alert media ezd-d-flex message_alert alert-<?php echo esc_attr( $settings['alert_type'] ) ?> fade show"
    ...
    <div class="media-body">
        ...
        <button type="button" class="close" data-dismiss="alert" data-id="<?php echo esc_attr( $this->get_id() ) ?>">
...
<div
    class="dual-box-wrapper notice-<?php echo esc_attr( $settings['alert_type'] . ' ' . $settings['dual-layer-alignment'] ) ?>">
