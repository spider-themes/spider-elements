                        ...
                        if ( !empty($tables)) {
                            foreach ( $tables as $index => $table ) {
                                ...
                                <div class="col-xl-<?php echo esc_attr( $settings['column'] ) ?> col-md-6<?php echo esc_attr($is_last_key) ?>">
                                    <div class="pricing-item-2 spe_pricing_item_wrapper wow fadeInUp<?php echo esc_attr($active); ?>" data-wow-delay="<?php echo esc_attr($delay_time) ?>s">
                                        <?php
                                        ...
                                        if ( !empty( $table['contents'] ) ) { ?>
                                            <div class="pack-feature spe_pricing_item_content"> <?php echo esc_html($table['contents']) ?> </div>
                                            <?php
                                        }
