    ...
    <nav>
        <div class="nav nav-tabs d-flex" id="nav-tab" role="tablist">
            <button class="nav-link spe_pricing_title active"
                    ...
                    data-bs-target="#cloud-monthly-<?php echo esc_attr( $this->get_id() ); ?>" type="button" role="tab"
            ...
            <button class="nav-link spe_pricing_title"
                    ...
                    data-bs-target="#cloud-annually-<?php echo esc_attr( $this->get_id() ); ?>" type="button" role="tab"
