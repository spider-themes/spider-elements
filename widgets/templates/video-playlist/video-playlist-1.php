        ...
        <div class="row justify-content-sm-between">
            ...
            <div class="col-lg-7">
                <div class="video_player">
                    <div class="tab-content video_tabs" id="<?php echo esc_attr(the_ID()); ?>">
						<?php
						...
						foreach ( $all_videos as $videos ) :
                            ...
                            <div class="card accordion-panel">
                                <div class="card">
                                    <div class="card-header">
                                        <button class="text-left accordion-header <?php echo esc_attr( $nav_collapse ); ?>"
                                                ...
                                                data-bs-target="#configuration<?php echo $count; ?>"
                                                aria-expanded="true"
                                ...
                                <div id="configuration<?php echo $count; ?>"
                                     class="accordion-content <?php if ( $count == 1 ) {
									     echo 'collapse show';
								     } ?>"
