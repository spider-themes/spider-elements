    ...
    <div class="row justify-content-sm-between">
        ...
        <div class="col-lg-5">
            <div class="video_list">
                <<?php echo esc_attr( $title_tag ); ?> class="title" data-animation="wow fadeInUp"
                data-wow-delay="0.2s">
                ...
                <div class="accordion" id="accordionExample" data-bs-accordion="true">
					...
					foreach ( $all_videos as $video_item ) {
                        ...
                        <div class="card accordion-panel">
                            <div class="card" id="configuration<?php echo esc_attr( $count ); ?>-tab">
                                    ...
                                    <button class="text-left accordion-header <?php echo esc_attr( $nav_collapse ); ?>"
                                        ...
                                        <span class="plus-minus">
                                            <svg fill="#000000" width="15px" height="15px" viewBox="0 0 24 24" id="plus"
                                                 ...
                                                 class="icon line-color"><path id="primary" d="M5,12H19M12,5V19"
                                                                               style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path></svg>
                                            <svg fill="#000000" width="15px" height="15px" viewBox="0 0 24 24"
                                                 id="minus" data-name="Line Color" xmlns="http://www.w3.org/2000/svg"
                                                 class="icon line-color"><line id="primary" x1="19" y1="12" x2="5"
                                                                               y2="12"
                                                                               style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></line></svg>
                                        </span>
                                    </button>
                                </div>
                            </div>
                            <div id="configuration<?php echo esc_attr( $count ); ?>"
                                 ...
                                 aria-labelledby="configuration<?php echo esc_attr( $count ); ?>-tab"
