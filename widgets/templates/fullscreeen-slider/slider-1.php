...
<section class="banner-area-2 banner-area-6" id="home">
                ...
                foreach ( $sliders as $item ) {
                    ...
                    <div class="swiper-slide" style="background-image: url('<?php echo esc_url($item['bg_img']['url']) ?>')">
                        <div class="banner-content text-center">
                            ...
                            if ( !empty($item['title']) ) {
                                ?>
                                <a <?php spe_the_button($item['btn_url']) ?> class="theme-btn theme-btn-outline-white mt-30">
    ...
    <div class="banner-thumbnails d-none d-md-block">
...
<!--                <circle class="path" cx="25" cy="25" r="20" fill="none" stroke="#fff" stroke-width="1"></circle>-->
<!--            </svg>-->
<!--        </div>-->
<!--    </div>-->
</section>