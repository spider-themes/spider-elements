...
class Animated_Headline extends Widget_Base
{
    ...
    {
        return 'se_animated_headline';
    }

    public function get_title()
    {
        return __('Animated Headline', 'spider-elements');
    }
    ...
    ?>
        ...
        <h1 class="cd-headline clip home-headline"><?php echo $settings['se_headline_before_text'] ?>
            <small class="cd-words-wrapper single-headline">
                ...
                foreach ($settings['cd_option_list'] as $cd_option_list) :
                    ...
                    $i++;
                    $slide_title1 = $cd_option_list['title1'];
                    $slide_title2 = $cd_option_list['title2'];
                ?>
                    <span class="is-<?php echo esc_attr($vihi); ?>"><b><?php echo esc_attr($slide_title1); ?></b> <?php echo esc_attr($slide_title2); ?></span>
                <?php endforeach; ?>
