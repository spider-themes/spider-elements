<?php
namespace Spider_Elements_Assets\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'spider-elements' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'spider-elements' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			...
			[
				...
				'default' => __( 'Title', 'spider-elements' ),
			]
		);
