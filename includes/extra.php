 ...
 */
if ( ! function_exists( 'spel_el_title_tags' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'spel_the_button' ) ) {
 ...
 * @return string
 */
if ( ! function_exists( 'spel_get_the_first_taxonomy' ) ) {
 ...
 * @return string
 */
if ( ! function_exists( 'spel_get_the_first_taxonomy_link' ) ) {
 ...
 * @return array
 */
if ( ! function_exists( 'spel_get_author_name' ) ) {
    function spel_get_author_name() {
        global $post;
        $byline = sprintf(
 ...
 * @return array
 */
if ( ! function_exists( 'spel_return_tab_data' ) ) {
    function spel_return_tab_data( $getCats, $schedule_cats ) {
        $y = [];
