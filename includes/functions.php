...
/**
 * Check if the Docy theme is active or if the user is premium
 *
 * @return bool
 * @since 1.0.0
 */
 ...
 * @param bool  $is_echo      Whether to echo the attributes or not.
 * @return void
 * @since 1.0.0
 */
 ...
 * Get reading time
 *
 * @param int $words_per_minute Words per minute count. Default 200.
 *
 * @return string
 * @since 1.0.0
 */
 ...
 *
 * @param array  $key   Image settings/ID.
...
if ( !function_exists('spel_pagination') ) {
     ...
     * @param string    $class CSS class for the pagination container.
