...
<div id="elements" class="tab-box">
    <div class="elements_tab_menu">
        ...
        <div class="menu_right_content">
            ...
            <?php wp_nonce_field( 'spel_elements_nonce' ); ?>
        </div>
    </div>
							...
							if ( ! empty( $item['label'] ) ) {
                                ...
                                <div class="link">
									...
									if ( ! empty( $item['demo_url'] ) ) {
										?>
                                        <a href="<?php echo esc_url( $item['demo_url'] ) ?>" class="tooltip-top" data-tooltip="<?php echo esc_attr( sprintf( __( 'View %s Widget Demo', 'spider-elements' ), $item['label'] ) ); ?>" target="_blank">
									...
									if ( ! empty( $item['video_url'] ) ) {
										?>
                                        <a href="<?php echo esc_url( $item['video_url'] ) ?>" class="tooltip-top" data-tooltip="<?php echo esc_attr( sprintf( __( 'View %s Video Tutorial', 'spider-elements' ), $item['label'] ) ); ?>" target="_blank">
									...
									if ( ! empty( $item['docs_url'] ) ) {
										?>
                                        <a href="<?php echo esc_url( $item['docs_url'] ) ?>" class="tooltip-top" data-tooltip="<?php echo esc_attr( sprintf( __( 'View %s Documentation', 'spider-elements' ), $item['label'] ) ) ?>" target="_blank">
