...
class Features_Badge {
    ...
    public function __construct() {
        ...
        //add_action( 'elementor/frontend/before_render', [ $this, 'check_script_enqueue' ) );
     ...
     * @access public
     */
    public function register_controls( object $element ): void
    {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => __( 'Global Badge', 'premium-addons-pro' ),
                'tab'   => $tab,
            ]
        );
     ...
     */
    public function add_content_controls( $element ): void
    {
        ...
        $element->add_control(
            ...
            array(
                ...
                'raw'             => __( 'How to use Premium Global Badge for Elementor »', 'premium-addons-pro' ),
