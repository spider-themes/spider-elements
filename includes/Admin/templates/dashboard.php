    ...
    <div class="ezd-grid ezd-grid-cols-12">
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                ...
                <h2 class="spe_dashboard_title">Documentation</h2>
                <p>Get detailed and guided instruction to level up your website with the necessary set up.</p>
                <a href="#" class="spe_dashboard_btn">Check Documentation</a>
            </div>
        </div>
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                <span class="spe_icon icon-help"></span>
                <h2 class="spe_dashboard_title">Need Help</h2>
                <p>If you are stuck at anything while using our product, reach out to us immidieatly</p>
                <a href="#" class="spe_dashboard_btn">Support Ticket</a>
            </div>
        </div>
    </div>
    <div class="ezd-grid ezd-grid-cols-12">
        <div class="ezd-lg-col-12">
            <div class="spe_support_item">
                <h2 class="spe_dashboard_title">System Requirement</h2>
                <div class="ezd-grid ezd-grid-cols-12">
                ...
                <div class="note">
                    <p>Note: If you have multiple addons like Element Pack so you need some more requirement some cases
                        so make sure you added more memory for others addon too.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="ezd-grid ezd-grid-cols-12">
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                ...
                <h2 class="spe_dashboard_title">Missing Features</h2>
                <p>Send us a message if you believe the plugin is<br> lacking any features.</p>
                <a href="#" class="spe_dashboard_btn">Request Features</a>
            </div>
        </div>
        <div class="ezd-lg-col-6">
        ...
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                ...
                <h2 class="spe_dashboard_title">Show Your Love</h2>
                <p>Leave your feedback to help us out if you liked<br> our product and customer service.</p>
                <a href="#" class="spe_dashboard_btn">Check Documentation</a>
            </div>
        </div>
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                ...
                <h2 class="spe_dashboard_title">Facing an issues?</h2>
                <p>You think there is a bug in the product? Inform<br> us please!</p>
                <a href="#" class="spe_dashboard_btn">Support Ticket</a>
            </div>
        </div>
    </div>
