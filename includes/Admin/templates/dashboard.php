    ...
    <div class="ezd-grid ezd-grid-cols-12">
        <div class="ezd-lg-col-6">
            <div class="spe_support_item">
                ...
                <p><?php esc_html_e('Get detailed and guided instruction to level up your website with the necessary set up.', 'spider-elements'); ?>
                </p>
            ...
            <div class="spe_support_item">
                ...
                <div class="ezd-grid ezd-grid-cols-12">
                    ...
                    <ul class="spe-list-unstyled spe_requirment_list ezd-lg-col-6">
                        ...
                        <li><strong>PHP Version</strong> <span><i class="icon-close"></i>Currently 256M</span></li>
                    ...
                    <ul class="spe-list-unstyled spe_requirment_list ezd-lg-col-6">
                        ...
                        <li><strong>Max post limit:</strong> <span><i class="icon-close"></i>Currently 1000M</span></li>
